...
function GetJsonMessageResponse($RequestMessageType,$EchoJArray)
{
	...
	if( $RequestMessageType == "IntentRequest" ){
		...
		if( $EchoJArray->request->intent->name == "today_collection" || $EchoJArray->request->intent->name == "today scollection" )
		{
			$NextNumber = $EchoJArray->session->attributes->countActionList->currentStep + 1;
			$SpeakPhrase = "vanakam tamil, tamil thai vazthu mattrum tamil saitheekal";
